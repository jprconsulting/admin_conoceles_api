...
namespace conoceles_api.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post(UsuarioDTO dto)
        {
            ...
            var existeUsuario = await context.Usuarios.AnyAsync(u => u.Nombres == dto.Nombres && u.ApellidoPaterno == dto.ApellidoPaterno);
            ...
            // Si el rol es candidato se agrega el candidato
            if (usuario.Rol.Id == 1)
            {
